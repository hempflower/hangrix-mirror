...
const markSessionContainerStopped = `-- name: MarkSessionContainerStopped :execrows
UPDATE agent_sessions
...
type MarkSessionContainerStoppedParams struct {
	ID       int64
	RunnerID pgtype.Int8
}
...
func (q *Queries) MarkSessionContainerStopped(ctx context.Context, arg MarkSessionContainerStoppedParams) (int64, error) {
	result, err := q.db.Exec(ctx, markSessionContainerStopped, arg.ID, arg.RunnerID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) MarkSessionIdle(ctx context.Context, arg MarkSessionIdleParams) (int64, error) {
	result, err := q.db.Exec(ctx, markSessionIdle, arg.ExitCode, arg.RunningJobs, arg.ID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const resumeSessionContainer = `-- name: ResumeSessionContainer :execrows
UPDATE agent_sessions
...
func (q *Queries) ResumeSessionContainer(ctx context.Context, id int64) (int64, error) {
	result, err := q.db.Exec(ctx, resumeSessionContainer, id)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
