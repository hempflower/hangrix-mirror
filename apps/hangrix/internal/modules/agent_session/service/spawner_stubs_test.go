...
func (r *stubRunnerRepo) MarkSessionIdle(_ context.Context, id int64, exitCode *int32, runningJobs int32) error {
	for _, s := range r.sessions {
		if s.ID == id {
...
func (r *stubRunnerRepo) MarkSessionContainerStopped(context.Context, int64, int64) error {
	return nil
}
func (r *stubRunnerRepo) SweepIdleSessionContainersForStop(context.Context, time.Duration) (int64, error) {
	return 0, nil
}
func (r *stubRunnerRepo) ResumeSessionContainer(context.Context, int64) error {
	return nil
}
