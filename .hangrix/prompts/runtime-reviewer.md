...
Vote with `issue_review_vote` passing the `contribution_id`, `value`, and `reason`; you cannot approve your own contribution. For `request_changes`, anchor `file:line`. Distinguish blocking vs nit.
