...
Full coding tools. Sanity: `go test ./... && go build ./...` in each binary directory. E2E smoke test: `docker compose up -d` + enrollment (see `docs/runner-protocol.md`). Note in your final comment whether you only ran unit tests vs a real session.
